...
| IP              | Host         | Updated |
|-----------------|--------------|---------|
| 192.168.100.10  | mini         | 2025    |
| 192.168.100.11  | asahi        | 2024    |
| 192.168.100.12  | gaming       | 2025    |
| 192.168.100.13  | dockingbay94 | 2024    |
| 192.168.100.14  | octoprint    | 2025    |
| 192.168.100.15  | wololo       | 2025    |
| 192.168.100.16  | bebop        | 2025    |
| 192.168.100.17  | ipad-m4      | 2024    |
| 192.168.100.18  | steamdeck    | 2025    |
| 192.168.100.30  | koality      | 2024    |
| 192.168.100.40  | m1 mini      | 2024    |
 
## Setup client

[Docs](https://nebula.defined.net/docs/guides/quick-start/)

- Install nebula from package manager (nix,pacman,snap)
...
- Replace following vaules in config:
...
- `journalctl -xeu nebula.service`

[systemd unit file](../../reference/systemd.md)

### Certificate renewal

- Resign certificate from server that contains ca.key

```bash
nebula-cert sign -name $HOSTNAME -ip "192.168.100.XX/24" -groups "$HOSTNAME,$GROUPNAME"
```

- Set calendar reminder for expire date
- Distribute new `hostname.crt`, `hostname.key`, `ca.crt` files to clients
